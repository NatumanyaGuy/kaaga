...
<div class="flex flex-row justify-center gap-2 p-5">
	<!-- Website  -->
	<a href="https://muriro.com" target="_blank" class="p-4 rounded-md shadow-sm hover:shadow-lg">
		<img src="/logo.png" class="w-12 h-12" title="Visit our main website" alt="" />
	</a>
